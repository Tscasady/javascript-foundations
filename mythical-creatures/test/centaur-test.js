...
describe('Centaur', function() {
  ...
  it('should have a name', function() {
    let centaur1 = new Centaur({name: 'test'})
    let centaur2 = new Centaur({name: 'other'})
    assert.equal(centaur1.name, 'test')
    assert.equal(centaur2.name, 'other')
    assert.notEqual(centaur2.name, 'test')
  });
